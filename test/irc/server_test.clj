...
(def server-minus-user3 {:host host
                         :version version
                         :create-date create-date
...
(def server-minus-user3-on-chan3 {:host host
                                  :version version
                                  :create-date create-date
...
(def server-plus-user7 {:host host
                        :version version
                        :create-date create-date
                        :users {uid1 user1 uid2 user2 uid3 user3 uid4 user4
...
(def server-minus-chan5  {:host host
                          :version version
                          :create-date create-date
                          :users {uid1 user1 uid2 user2 uid3 user3 uid4 user4
                                  uid5 user5 uid6 user6}
...
(def server-user7 {:host host
                   :version version
                   :create-date create-date
                   :users {uid7 user7}
                   :channels {}})

(def server-user7-nick {:host host
                        :version version
                        :create-date create-date
                        :users {uid7 user7-nick}
                        :channels {}})

(def server-user7-realname {:host host
                            :version version
                            :create-date create-date
                            :users {uid7 user7-realname}
                            :channels {}})

(def server-user7-registered {:host host
                              :version version
                              :create-date create-date
